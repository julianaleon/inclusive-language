...
module.exports = app => {
  ...
  app.on(['pull_request.opened', 'pull_request.edited'], async context => {
      ...
      if (hasProhibittedTerm) {
          const params = context.issue({body: 'Hey! {term} is considered problematic language, maybe you could try using {replacement} instead to use more inclusive language? [Here\'s why.](https://confluence.expedia.biz/pages/viewpage.action?pageId=1607388080)'})
